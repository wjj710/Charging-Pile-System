...
int Global::waitingAreaSize; //等候区大小
int Global::chargingQueueLen; //充电桩队列长度
int Global::fastChargingPileNum; //快充电桩数目
int Global::trickleChargingPileNum; //慢充电桩数目
...
QEventLoop Global::loop; //事件循环，用于同步通信
